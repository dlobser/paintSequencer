...
public class beatManagerVive : MonoBehaviour {
...
//			c.trailMat = trailMat;
	...
	void Update () {
       ...
       // SteamVR_Controller.Input(3).GetTouchDown(EVRButtonId.k_EButton_SteamVR_Trigger);
       // Debug.Log(SteamVR_Controller.Input(4).GetTouch(EVRButtonId.k_EButton_SteamVR_Trigger));
        ...
        if (SteamVR_Controller.Input(4).GetTouch(EVRButtonId.k_EButton_SteamVR_Trigger)) {
            deleteMode = true;
        } else {
            deleteMode = false;
        }
        if (SteamVR_Controller.Input(2).GetTouch(EVRButtonId.k_EButton_SteamVR_Trigger)) {
            Vector3 hit = SteamVR_Controller.Input(2).transform.pos;// hitPoint();
            if (activeBulb==null) {
